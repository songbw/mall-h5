      ...
      <div class="payBox">
        ...
        <div class="pathBox">
          <van-radio-group v-model="radio">
            ...
            <div v-if="this.$api.PLATFORM_ID === this.$api.PLATFORM_TYPE.isFcWxPub">
            ...
            <div v-else-if="(this.$api.PLATFORM_ID != this.$api.PLATFORM_TYPE.isFcWxPub) && this.$api.APP_SOURCE == '00'">
